...
const Footer = () => {
    return (
        <footer className=" border-t-2 border-gray-200 mt-auto">
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
                    ...
                    <div className="flex flex-col items-center space-y-4">
                        <h3 className="text-sm font-semibold text-gray-800 font-inter">This project is under the support of</h3>
                    ...
                    <div className="flex flex-col items-center md:items-end space-y-3">
                        <h3 className="text-sm font-semibold text-gray-800 font-inter">Contact</h3>
                        <div className="text-center md:text-right text-sm text-gray-600 space-y-1 leading-relaxed">
                            <div className="font-medium text-gray-800">Software Engineering Research Center</div>
